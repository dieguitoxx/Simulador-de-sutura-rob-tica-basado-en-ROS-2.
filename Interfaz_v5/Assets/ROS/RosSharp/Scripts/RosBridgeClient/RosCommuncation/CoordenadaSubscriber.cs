...
namespace RosSharp.RosBridgeClient
{
    public class CoordenadaSubscriber : UnitySubscriber<MessageTypes.Tf2.TFMessage>
    {
        ...
        private List<Text> Cartesiano = new List<Text>();    //Casillas de texto del panel cartesiano
        ...
        {
            Posicion[0].text = ("Px: ")+10.0f.ToString("f3");
            Posicion[1].text = ("Py: ")+10.0f.ToString("f3");
            Posicion[2].text = ("Pz: ")+10.0f.ToString("f3");

            rotationD = ConvertirAngulos(rotationQ);
            
            Posicion[3].text = ("Rx: ")+10.0f.ToString("f3");
            Posicion[4].text = ("Ry: ")+10.0f.ToString("f3");
            Posicion[5].text = ("Rz: ")+10.0f.ToString("f3");
        }

        private void MensajeCartesiano()                            //Asigna las coordenadas a las casillas de texto del panel cartesiano
        {
            //Cartesiano
            Cartesiano[0].text = 10.0f.ToString("f3");
            Cartesiano[1].text = 10.0f.ToString("f3");
            Cartesiano[2].text = 10.0f.ToString("f3");

            rotationD = ConvertirAngulos(rotationQ);

            Cartesiano[3].text = 10.0f.ToString("f3");
            Cartesiano[4].text = 10.0f.ToString("f3");
            Cartesiano[5].text = 10.0f.ToString("f3");
        }
