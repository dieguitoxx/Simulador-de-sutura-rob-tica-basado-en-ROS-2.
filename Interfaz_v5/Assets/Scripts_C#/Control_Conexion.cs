...
namespace RosSharp.RosBridgeClient
{
    ...
    public class Control_Conexion : MonoBehaviour
    {
        ...
        public JointStateSubscriber SubArtRobot;                 //Script del suscriptor articular del robot
        public JointStateSubscriber SubArtPinza;                 //Script del suscriptor articular de la endowrist
	public JointStateSubscriber SubArtRobot2;		//Script del suscriptor del robot 2
       ...
       // public CoorPublisher PubCoor;                       //Script del publicador cartesiano
        ...
        public TMP_Text Estado;                                 //Texto del estado en el panel de conexion
        ...
        {
            SubArtRobot.enabled = true;
            SubArtRobot.Suscribir();
	    SubArtRobot2.enabled = true;
            SubArtRobot2.Suscribir();
            SubArtPinza.enabled = true;
            SubArtPinza.Suscribir();
        ...
        {
            SubArtRobot.enabled = false;
	    SubArtRobot2.enabled = false;
            SubArtPinza.enabled = false;
