...
statePublisher = rospy.Publisher('/Trayectorias_matlab', ModelState, queue_size=10)
stateMsg = ModelState()

pub_robot = rospy.Publisher('/joint_states', JointState, queue_size=10)
pub_robotMsg = JointState()
...
pub_traj = rospy.Publisher('/pose_array_topic', PoseArray, queue_size=10)

topic_name = '/tf'
message_type = 'tf2_msgs/TFMessage'     


pub_path_endo = rospy.Publisher('/pose_path_endo', PoseArray, queue_size=10)
