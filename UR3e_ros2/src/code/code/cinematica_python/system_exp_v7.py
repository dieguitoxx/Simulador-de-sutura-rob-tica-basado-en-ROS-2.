...
def publicar_virtual(m_q_vec_ik,m_efector2,modo):
  ...
  #  m_q_vec_ik = m_q_vec_ik1[::-1]
    ...
    pickle_path = os.path.join(package_path, "cinematica_python", "datos.pickle")
...
def calcular_ik2(M_tray_endo_sale2,q_initr):
...
#___desde camara______
              ...
              #  m_q_vec_ik = m_q_vec_ik1[::-1]
                package_path = get_package_share_directory("code")
                pickle_path = os.path.join(package_path, "cinematica_python", "data1.pickle")
                with open(pickle_path, "rb") as archivo:
...
# _______________estado 3  calculo cinematica inversa
     ...
     #                   print("el ciclo i2",i2)
                 ...
                 #       print("matriz para calcular ik ",M_tray_endo_sale_r)
                        ...
                        q_vec_ik1=calcular_ik2(M_tray_endo_sale_r,q_init)
